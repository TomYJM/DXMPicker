...
+ (void)showHUDtoDiss:(NSString*)title ToView:(UIView*)view
{
...
+ (MB_INSTANCETYPE)showHUDandWindowAnimated:(BOOL)animated
{
    DXMAppDelegate *appDelegate = (DXMAppDelegate *)[UIApplication sharedApplication].delegate;
    return [MBProgressHUD showHUDAddedTo:appDelegate.window animated:animated];
}

+ (NSUInteger)hideAllHUDsForWindowAnimated:(BOOL)animated
{
    DXMAppDelegate *appDelegate = (DXMAppDelegate*)[UIApplication sharedApplication].delegate;
    return [MBProgressHUD hideAllHUDsForView:appDelegate.window animated:animated];
}
